...
}elseif ($_SESSION['level'] == 'pembeli' | $_SESSION['level'] == 'kasir' ) {
...
if(isset($_GET['pesan'])){
	...
	if($pesan=="gagal"){
		...
		echo "<div class='alert alert-danger'>Registrasi Gagal ! ID ini belum terdaftar <a href='registrasi-form.php' data-rel='close'><i class='entypo-cancel'></i></a> </div>";
	}
		...
		echo "<div class='alert alert-warning'>Password yang anda masukkan tidak sesuai  !!     silahkan ulangi !! <a href='registrasi-form.php' data-rel='close'><i class='entypo-cancel'></i></a> </div>";
	}else if($pesan=="oke"){
		echo "<div class='alert alert-success'>Registrasi telah berhasil <a href='registrasi-form.php' data-rel='close'><i class='entypo-cancel'></i></a> </div>";
	}
}
?>
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
							...
							<a href="pengajuan-absensi.php"><strong>Registrasi</strong></a>
					</li>
					</ol>
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form role="form" method="POST" class="form-horizontal form-groups-bordered" enctype="multipart/form-data" action="registrasi-act.php">
					<div class="form-group">
						<label for="field-3" class="col-sm-3 control-label">Pembeli atau Pegawai</label>
						
						<div class="col-sm-5">
							<input type="radio" name="pilihan" value="pembeli" required> Pembeli
							<input type="radio" name="pilihan" value="pegawai" required> Pegawai
						</div>
					</div>
					<div class="form-group">
						<label for="field-3" class="col-sm-3 control-label">ID</label>
						
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="id"	required />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="user"	required />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="password" class="form-control" id="field-1" name="pass"	required />
						</div>
					</div>
					<div class="form-group">
