...
if(isset($_GET['pesan'])){
	...
	if($pesan=="gagal"){
		...
		echo "<div class='alert alert-danger'>Registrasi Gagal ! ID ini belum terdaftar <a href='pembeli-form.php' data-rel='close'><i class='entypo-cancel'></i></a> </div>";
	}
	...
	else if($pesan=="kurang"){
		echo "<div class='alert alert-warning'>Maaf stok kurang dari yang anda inginkan !<a href='pembeli-form.php' data-rel='close'><i class='entypo-cancel'></i></a> </div>";
	}else if($pesan=="sukses"){
		echo "<div class='alert alert-success'>Pembelian telah berhasil, silahkan menghungi kasir untuk pembayaran <a href='pembeli-form.php' data-rel='close'><i class='entypo-cancel'></i></a> </div>";
	}
}
?>
<?php 	
 ...
 ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
							...
							<a href="pembeli-form.php"><strong>Beli Hanphone</strong></a>
					</li>
					</ol>
	...
	<div class="col-md-2">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-heading">
				...
				<?php echo $row['merk_hp'] ?> <?php echo $row['tipe_hp'] ?>
				</div>
			...
			<div class="panel-body">
				...
				<form role="form" method="POST" class="form-horizontal form-groups-bordered" action="tambah-barang-masuk.php">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<img src="images/<?php echo $row['gambar'] ?> ?>" style="width: 210PX ; height: 210px;">
					...
					<div class="form-group">
						<div class="col-sm-5">
							<?php if ($row['stok']==0): ?>
								<?php echo "<a href='#myModal3' class='btn btn-danger btn-sm btn-icon icon-left' id='custId' data-toggle='modal' data-id=".$row['id']."><i class='entypo-basket'></i>Beli</a>"; ?>
							<?php endif ?>
							<?php if ($row['stok'] > 0): ?>
								<?php echo "<a href='#myModal3' class='btn btn-default btn-sm btn-icon icon-left' id='custId' data-toggle='modal' data-id=".$row['id']."><i class='entypo-basket'></i>Beli</a>"; ?>
							<?php endif ?>
